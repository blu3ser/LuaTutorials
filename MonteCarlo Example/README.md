...
4. **Base + Variations**: You can have a base scenario (built in editor) plus variations (generated by event script)

5. **Conditional Logic**: Simple `if/then` statements control what gets added/modified based on iteration number

6. **Flexibility**: Use the event for as much or as little as you need - just the variations, or the entire scenario
